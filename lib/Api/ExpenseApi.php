...
class ExpenseApi
{
     ...
     * @return \Swagger\Client\Model\ExpenseEntity[]
     */
    public function getGetExpenses($order_by = null, $order = null, $begin = null, $end = null, $refundable = null, $exported = null, $term = null, $page = null, $size = null)
    {
        list($response) = $this->getGetExpensesWithHttpInfo($order_by, $order, $begin, $end, $refundable, $exported, $term, $page, $size);
        return $response;
    }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getGetExpensesAsync($order_by = null, $order = null, $begin = null, $end = null, $refundable = null, $exported = null, $term = null, $page = null, $size = null)
    {
        return $this->getGetExpensesAsyncWithHttpInfo($order_by, $order, $begin, $end, $refundable, $exported, $term, $page, $size)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getGetExpensesAsyncWithHttpInfo($order_by = null, $order = null, $begin = null, $end = null, $refundable = null, $exported = null, $term = null, $page = null, $size = null)
    {
        $returnType = '\Swagger\Client\Model\ExpenseEntity[]';
        $request = $this->getGetExpensesRequest($order_by, $order, $begin, $end, $refundable, $exported, $term, $page, $size);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getGetExpensesRequest($order_by = null, $order = null, $begin = null, $end = null, $refundable = null, $exported = null, $term = null, $page = null, $size = null)
    {
     ...
     * @param  \Swagger\Client\Model\IdMetaBody4 $body body (optional)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Model\ExpenseEntity
     ...
     *
     * @param  string $id Expense record ID to set the meta-field value for (required)
     * @param  \Swagger\Client\Model\IdMetaBody4 $body (optional)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\ExpenseEntity, HTTP status code, HTTP response headers (array of strings)
