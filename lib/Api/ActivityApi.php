...
class ActivityApi
{
    ...
    /**
     * Operation deleteDeleteActivity
     *
     ...
     * @return void
     */
    public function deleteDeleteActivity($id)
    {
        $this->deleteDeleteActivityWithHttpInfo($id);
    }

    /**
     * Operation deleteDeleteActivityWithHttpInfo
     *
     * Delete an existing activity
     *
     * @param  string $id Activity ID to delete (required)
     ...
     */
    public function deleteDeleteActivityWithHttpInfo($id)
    {
        $returnType = '';
        $request = $this->deleteDeleteActivityRequest($id);
    ...
    /**
     * Operation deleteDeleteActivityAsync
     *
     * Delete an existing activity
     *
     * @param  string $id Activity ID to delete (required)
     ...
     */
    public function deleteDeleteActivityAsync($id)
    {
        return $this->deleteDeleteActivityAsyncWithHttpInfo($id)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation deleteDeleteActivityAsyncWithHttpInfo
     *
     * Delete an existing activity
     *
     * @param  string $id Activity ID to delete (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteDeleteActivityAsyncWithHttpInfo($id)
    {
        $returnType = '';
        $request = $this->deleteDeleteActivityRequest($id);
    ...
    /**
     * Create request for operation 'deleteDeleteActivity'
     *
     * @param  string $id Activity ID to delete (required)
     *
     * @throws \InvalidArgumentException
     ...
     */
    protected function deleteDeleteActivityRequest($id)
    {
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling deleteDeleteActivity'
            );
        }
