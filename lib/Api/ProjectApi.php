...
class ProjectApi
{
     ...
     * @return void
     */
    public function deleteDeleteProject($id)
    {
        $this->deleteDeleteProjectWithHttpInfo($id);
    }

    /**
     * Operation deleteDeleteProjectWithHttpInfo
     *
     * Delete an existing project
     *
     * @param  string $id Project ID to delete (required)
     ...
     */
    public function deleteDeleteProjectWithHttpInfo($id)
    {
        $returnType = '';
        $request = $this->deleteDeleteProjectRequest($id);
    ...
    /**
     * Operation deleteDeleteProjectAsync
     *
     * Delete an existing project
     *
     * @param  string $id Project ID to delete (required)
     ...
     */
    public function deleteDeleteProjectAsync($id)
    {
        return $this->deleteDeleteProjectAsyncWithHttpInfo($id)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation deleteDeleteProjectAsyncWithHttpInfo
     *
     * Delete an existing project
     *
     * @param  string $id Project ID to delete (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteDeleteProjectAsyncWithHttpInfo($id)
    {
        $returnType = '';
        $request = $this->deleteDeleteProjectRequest($id);
    ...
    /**
     * Create request for operation 'deleteDeleteProject'
     *
     * @param  string $id Project ID to delete (required)
     *
     * @throws \InvalidArgumentException
     ...
     */
    protected function deleteDeleteProjectRequest($id)
    {
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling deleteDeleteProject'
            );
        }
