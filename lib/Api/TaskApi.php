...
class TaskApi
{
     ...
     * @param  string $page_size DEPRECATED: The amount of entries for each page (default: 50) (optional)
     ...
     * @return \Swagger\Client\Model\Task[]
     */
    public function getGetTasks($search_term = null, $customers = null, $projects = null, $activities = null, $tags = null, $users = null, $teams = null, $status = null, $page_size = null, $page = null, $size = null, $order = null, $order_by = null)
    {
        list($response) = $this->getGetTasksWithHttpInfo($search_term, $customers, $projects, $activities, $tags, $users, $teams, $status, $page_size, $page, $size, $order, $order_by);
        return $response;
    }
     ...
     * @return array of \Swagger\Client\Model\Task[], HTTP status code, HTTP response headers (array of strings)
     */
    public function getGetTasksWithHttpInfo($search_term = null, $customers = null, $projects = null, $activities = null, $tags = null, $users = null, $teams = null, $status = null, $page_size = null, $page = null, $size = null, $order = null, $order_by = null)
    {
        $returnType = '\Swagger\Client\Model\Task[]';
        $request = $this->getGetTasksRequest($search_term, $customers, $projects, $activities, $tags, $users, $teams, $status, $page_size, $page, $size, $order, $order_by);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getGetTasksAsync($search_term = null, $customers = null, $projects = null, $activities = null, $tags = null, $users = null, $teams = null, $status = null, $page_size = null, $page = null, $size = null, $order = null, $order_by = null)
    {
        return $this->getGetTasksAsyncWithHttpInfo($search_term, $customers, $projects, $activities, $tags, $users, $teams, $status, $page_size, $page, $size, $order, $order_by)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getGetTasksAsyncWithHttpInfo($search_term = null, $customers = null, $projects = null, $activities = null, $tags = null, $users = null, $teams = null, $status = null, $page_size = null, $page = null, $size = null, $order = null, $order_by = null)
    {
        $returnType = '\Swagger\Client\Model\Task[]';
        $request = $this->getGetTasksRequest($search_term, $customers, $projects, $activities, $tags, $users, $teams, $status, $page_size, $page, $size, $order, $order_by);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getGetTasksRequest($search_term = null, $customers = null, $projects = null, $activities = null, $tags = null, $users = null, $teams = null, $status = null, $page_size = null, $page = null, $size = null, $order = null, $order_by = null)
    {
     ...
     */
    public function getTasksTimesheets($id)
    {
        list($response) = $this->getTasksTimesheetsWithHttpInfo($id);
        return $response;
    }

    /**
     * Operation getTasksTimesheetsWithHttpInfo
     *
     * Returns a collection of timesheets for one task
     *
     ...
     */
    public function getTasksTimesheetsWithHttpInfo($id)
    {
        $returnType = '\Swagger\Client\Model\TimesheetCollectionExpanded[]';
        $request = $this->getTasksTimesheetsRequest($id);
    ...
    /**
     * Operation getTasksTimesheetsAsync
     *
     * Returns a collection of timesheets for one task
     *
     * @param  string $id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getTasksTimesheetsAsync($id)
    {
        return $this->getTasksTimesheetsAsyncWithHttpInfo($id)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getTasksTimesheetsAsyncWithHttpInfo
     *
     * Returns a collection of timesheets for one task
     *
     * @param  string $id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getTasksTimesheetsAsyncWithHttpInfo($id)
    {
        $returnType = '\Swagger\Client\Model\TimesheetCollectionExpanded[]';
        $request = $this->getTasksTimesheetsRequest($id);
    ...
    /**
     * Create request for operation 'getTasksTimesheets'
     *
     * @param  string $id (required)
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getTasksTimesheetsRequest($id)
    {
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling getTasksTimesheets'
            );
        }

        $resourcePath = '/api/tasks/{id}/timesheets';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation patchKimaipluginTaskmanagementApiTaskMeta
     *
     * Sets the value of a meta-field for an existing task
     *
     * @param  string $id Task record ID to set the meta-field value for (required)
     ...
     * @return \Swagger\Client\Model\Task
     */
    public function patchKimaipluginTaskmanagementApiTaskMeta($id, $body = null)
    {
        list($response) = $this->patchKimaipluginTaskmanagementApiTaskMetaWithHttpInfo($id, $body);
        return $response;
    }

    /**
     * Operation patchKimaipluginTaskmanagementApiTaskMetaWithHttpInfo
     *
     * Sets the value of a meta-field for an existing task
     *
     * @param  string $id Task record ID to set the meta-field value for (required)
     ...
     * @return array of \Swagger\Client\Model\Task, HTTP status code, HTTP response headers (array of strings)
     */
    public function patchKimaipluginTaskmanagementApiTaskMetaWithHttpInfo($id, $body = null)
    {
        $returnType = '\Swagger\Client\Model\Task';
        $request = $this->patchKimaipluginTaskmanagementApiTaskMetaRequest($id, $body);
    ...
    /**
     * Operation patchKimaipluginTaskmanagementApiTaskMetaAsync
     *
     * Sets the value of a meta-field for an existing task
     *
     * @param  string $id Task record ID to set the meta-field value for (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function patchKimaipluginTaskmanagementApiTaskMetaAsync($id, $body = null)
    {
        return $this->patchKimaipluginTaskmanagementApiTaskMetaAsyncWithHttpInfo($id, $body)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation patchKimaipluginTaskmanagementApiTaskMetaAsyncWithHttpInfo
     *
     * Sets the value of a meta-field for an existing task
     *
     * @param  string $id Task record ID to set the meta-field value for (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function patchKimaipluginTaskmanagementApiTaskMetaAsyncWithHttpInfo($id, $body = null)
    {
        $returnType = '\Swagger\Client\Model\Task';
        $request = $this->patchKimaipluginTaskmanagementApiTaskMetaRequest($id, $body);
    ...
    /**
     * Create request for operation 'patchKimaipluginTaskmanagementApiTaskMeta'
     *
     * @param  string $id Task record ID to set the meta-field value for (required)
     * @param  \Swagger\Client\Model\IdMetaBody1 $body (optional)
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function patchKimaipluginTaskmanagementApiTaskMetaRequest($id, $body = null)
    {
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling patchKimaipluginTaskmanagementApiTaskMeta'
            );
        }

        $resourcePath = '/api/tasks/{id}/meta';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
