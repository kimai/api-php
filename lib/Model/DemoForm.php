 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class DemoForm implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'DemoForm';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['_token'] === null) {
            $invalidProperties[] = "'_token' can't be null";
        }
     ...
     * Sets _token
     *
     * @param string $_token CSRF token
     *
     * @return $this
     */
