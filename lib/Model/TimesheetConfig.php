...
class TimesheetConfig implements ModelInterface, ArrayAccess
{
    ...
    {
        $this->container['tracking_mode'] = isset($data['tracking_mode']) ? $data['tracking_mode'] : 'default';
        $this->container['default_begin_time'] = isset($data['default_begin_time']) ? $data['default_begin_time'] : 'now';
        $this->container['active_entries_hard_limit'] = isset($data['active_entries_hard_limit']) ? $data['active_entries_hard_limit'] : 1;
        $this->container['is_allow_future_times'] = isset($data['is_allow_future_times']) ? $data['is_allow_future_times'] : true;
        $this->container['is_allow_overlapping'] = isset($data['is_allow_overlapping']) ? $data['is_allow_overlapping'] : true;
    }
