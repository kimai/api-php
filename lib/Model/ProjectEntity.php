...
class ProjectEntity implements ModelInterface, ArrayAccess
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['global_activities'] = isset($data['global_activities']) ? $data['global_activities'] : true;
        $this->container['number'] = isset($data['number']) ? $data['number'] : null;
        $this->container['budget'] = isset($data['budget']) ? $data['budget'] : 0;
        $this->container['time_budget'] = isset($data['time_budget']) ? $data['time_budget'] : 0;
